 ...
 *
 * @package     RedITEM.Libraries
 * @subpackage  Helper.MobileDetect
 * @since       2.1.19
 *
 */
class ReditemHelperMobiledetect
{

	/**
	 * Mobile_Detect object.
	 *
	 * @var  object
	 */
	...
	/**
	 * Check if mobile device is trying to access web page.
	 *
	 ...
	 * @return  bool
	 */
	public static function isMobile($headers = array(), $userAgent = '')
	{
		if (is_null(self::$obj))
		{
			self::$obj = new Mobile_Detect($headers, $userAgent);
		}

		if (!empty(self::$obj) && self::$obj->isMobile())
		{
			return true;
		}
	...
	/**
	 * Check if tablet device is trying to access web page.
	 *
	 * @param   array   $headers    Http headers.
	 * @param   string  $userAgent  User agent.
	 *
	 * @return  bool
	 */
	public static function isTablet($headers = array(), $userAgent = '')
	{
		if (is_null(self::$obj))
		{
			self::$obj = new Mobile_Detect($headers, $userAgent);
		...
		if (!empty(self::$obj) && self::$obj->isTablet())
		{
			return true;
		}
