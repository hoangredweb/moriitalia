...
<tr class="<?php if ($isDone) : echo 'success'; endif;?>" id="task-<?php echo $taskNo; ?>">
	...
	<td>
		<div class="btn-group">
			<button class="btn btn-success" id="task-<?php echo $taskNo; ?>-done-btn" onclick="changeTaskStatus(<?php echo $taskNo; ?>); return false;">
			<?php if ($isDone):?>
			...
			<button class="btn btn-success" id="task-<?php echo $taskNo; ?>-paid-btn" onclick="willBePaid(<?php echo $taskNo; ?>); return false;">
				<?php if ($willBePaid):?>
					<i class="icon icon-check"></i>
