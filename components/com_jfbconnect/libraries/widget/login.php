...
class JFBConnectProviderWidgetLogin extends JFBConnectWidget
{
    ...
    function __construct($provider, $fields, $className)
    {
        ...
        $this->providerLoginInfo['Yahoo'] = new LoginButtonInfo('scYahooLoginTag', 'SCYahooLogin', 'sc_yhlogin', 'COM_JFBCONNECT_LOGIN_USING_YAHOO', 'scYahooLogin', 'scYahooLogoutButton');
    }
