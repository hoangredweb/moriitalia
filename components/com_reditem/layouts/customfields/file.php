...
<script type="text/javascript">
	jQuery(document).ready(function($){
		$('#filefield_<?php echo $fieldcode; ?>_<?php echo $id; ?>').dragndrop({
...
<div class="reditem_customfield_file">
	...
	<div upload-type="file" id="filefield_<?php echo $fieldcode; ?>_<?php echo $id; ?>" target="<?php echo $fieldcode; ?>"></div>
	<small>
		<?php echo JText::sprintf('COM_REDITEM_FIELD_FILE_NOTICE_UPLOAD_FILESIZE', $uploadMaxFilesize); ?>
