...
<div class="reditem_customfield_itemfromtype">
	<select name="cform[itemfromtype][<?php echo $fieldcode; ?>][]" id="cform_itemfromtype_<?php echo $fieldcode; ?>" <?php echo $attributes; ?>>
		<?php if (!empty($data)) : ?>
