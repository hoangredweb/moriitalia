...
class RedshopViewManufacturers extends RedshopView
{
	...
	public function display($tpl = null)
	{
		...
		if ($layout != 'default')
		{
			$manufacturer = !empty($detail) && !empty($detail[0]) ? $detail[0] : null;

			if (null !== $manufacturer && $manufacturer->id)
			{
				$mid = $manufacturer->id;
				...
				if (Redshop::getConfig()->get('AUTOGENERATED_SEO') && Redshop::getConfig()->get('SEO_PAGE_TITLE_MANUFACTUR') != '')
				{
					...
					$pagetitletag = str_replace("{manufacturer}", $manufacturer->name, $pagetitletag);
				...
				if (Redshop::getConfig()->get('AUTOGENERATED_SEO') && Redshop::getConfig()->get('SEO_PAGE_KEYWORDS_MANUFACTUR') != '')
				{
					...
					$pagekeywordstag = str_replace("{manufacturer}", $manufacturer->name, $pagekeywordstag);
				...
				else
				{
					...
					{
						$document->setMetaData('keywords', $manufacturer->name);
					}
				}
				...
				if (Redshop::getConfig()->get('AUTOGENERATED_SEO') && Redshop::getConfig()->get('SEO_PAGE_DESCRIPTION_MANUFACTUR') != '')
				{
					...
					$pagedesctag = str_replace("{manufacturer}", $manufacturer->name, $pagedesctag);
				...
				else
				{
					...
					{
						$document->setMetaData('description', $manufacturer->name);
					}
				}
				...
				if (Redshop::getConfig()->get('AUTOGENERATED_SEO') && Redshop::getConfig()->get('SEO_PAGE_HEADING_MANUFACTUR') != '')
				{
					...
					$pageheadingtag = str_replace("{manufacturer}", $manufacturer->name, $pageheadingtag);
				}
				...
				if (Redshop::getConfig()->get('AUTOGENERATED_SEO') && Redshop::getConfig()->get('SEO_PAGE_CANONICAL_MANUFACTUR') != '' && $layout != "products")
				{
					...
					$manufacturer_products_url = substr_replace(JURI::root(), "", -1)
						. JRoute::_('index.php?option=com_redshop&view=manufacturers&layout=products&mid=' . $manufacturer->id . '&Itemid=' . $itemId);
