...
(function($, window, document, undefined) {
    $.fn.socialfeed = function(_options) {
        ...
        var defaults = {
            ...
            template: 'modules/mod_social_feed/tmpl/template.html', // a path to the template file
            ...
            facebook: {
                ...
                getData: function(account) {
                    ...
                    var fields = '?fields=id,from,name,message,created_time,story,description,link';
                       fields += (options.show_media == 1)?',picture,object_id':'';
                ...
                utility: {
                    ...
                    unifyPostData: function(index, element){
                        ...
                        if (options.show_media && element.mediaGroups ) {
                            post.attachment = element.mediaGroups[0].contents[0].url;
                        }
                        return post;
                    }
                }
