                    ...
                    <li class="item-145">
                        <div class="inner">
                            <a href="{category_link}">
                                <img src="{category_image_nolink}"/>
                                <span class="btn image-title">{category_name_nolink}</span>
                            </a>
                        </div>
                    </li>
                    {category_loop_end}
    ...
    <div class="category_main_toolbar">
        <div class="row">
            <div class="col-sm-5">
                ...
                <div class="count_totalproduct">{total_product_lbl} {total_product}</div>
            </div>
        ...
        <div id="productlist" class="row">
            ...
            <div class="cate_redshop_products_wrapper col-sm-4 col-xs-6">
                <div class="inner_redshop_products">
                    <button type="button" class="btn btn-info btn-lg quick-view" data-toggle="modal"
                            data-target="#quick-view-{product_id}">{Quickview}
                    </button>
                    <div class="hover"></div>
                    {if product_on_sale}
                                    ...
                                    <div class="redSHOP_product_box clearfix">
                                        <div class="redSHOP_product_box_right">
                                            <div class="redSHOP_product_detail_box">
                                                ...
                                                <div class="in-stock"><i class="icon-time"></i>{producttag:rs_low_in_stock}
                                                </div>
