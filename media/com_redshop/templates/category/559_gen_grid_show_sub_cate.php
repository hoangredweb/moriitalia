<div class='category_wrapper parent'>
	<div class='category_header'>
		...
		<button class="back-category">{back_category}</button>
		<button class="all-product">{view_all_products}</button>
	 <div class="clearfix"></div>
			...
			<div class="cate_redshop_products_wrapper col-sm-4 col-xs-6 hidden">
				<div class="inner_redshop_products">
						...
						<div class="category_product_price">
                  		...
                  		<div class="mod_redshop_products_addtocart">
                          {form_addtocart:gen_add_to_cart1}
                  		</div>
                  		<div class='mod_redshop_products_title'>{product_name}</div>
