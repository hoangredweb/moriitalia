 ...
 * @since  2.1
 */
class Sh404sefExtpluginCom_Reditem extends Sh404sefClassBaseextplugin
{
	/**
	 * Extension name.
	 *
	 ...
	 * @deprecated  3.0
	 */
	protected $_extName = 'com_reditem';
	...
	{
		$this->_sefPluginPath = JPATH_ROOT . '/plugins/sh404sefextplugins/sh404sefextplugincom_reditem/reditem/sef.php';
	}
}
