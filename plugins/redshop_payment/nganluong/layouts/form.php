...
<form  name="NLpayBank" action="<?php echo $action; ?>" method="post">
	<ul class="list-content">
		<li class="active">
			<label><input checked="checked" type="radio" value="NL" name="option_payment" selected="true"><?php echo JText::_('PLG_REDSHOP_PAYMENT_NGANLUONG_CHECKOUT_NGANLUONG_WALLET'); ?></label>
