...
$linkCss = '<link rel="stylesheet" href="' . $siteUrl . 'plugins/system/jotcache/jotcache/plg_jotcache.css?ver=5.1.4" type="text/css" />';
...
JResponse::setHeader('Content-Type', 'application/rss+xml; charset=utf-8');
}else{
