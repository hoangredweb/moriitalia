...
class JFormFieldRebrand extends JFormField
{
	...
	protected function getInput()
	{
		...
		if (stripos($author, 'shack'))
			$html[] = '&nbsp;<a class="modal" rel="{\'handler\': \'iframe\', \'size\': {x: 800, y:600}}"" href="https://www.joomlashack.com/joomla-template/licensing-center">' . JText::_('TPL_GENSHOP_FIELD_REBRAND_LICENSE') . '</a>';
