...
class JFormFieldColumns extends JFormField
{
	...
	function getInput()
	{
		...
		$html = '<p id="column_info">' . JText::_('TPL_GENSHOP_FIELD_COLUMNS_USING') . ' <span id="columns_used"></span> ' . JText::_('TPL_GENSHOP_FIELD_COLUMNS_OF') . ' <span id="columnsNumber">' . $tplNumber . '</span> <span id="columns_warning">' . JText::_('TPL_GENSHOP_FIELD_COLUMNS_WARNING') . ' <span id="columnsNumber2">' . $tplNumber . '</span></span></p>';
		...
		{
			$html .= '<div id="column_' . $column[0] . '" class="col span' . $column[1] . '" style="text-align:center;"><span style="display: block; text-align:center;"><a onclick="swapColumns(\'' . $column[0] . '\', \'left\')"><i class="icon-arrow-left"></i></a><a onclick="swapColumns(\'' . $column[0] . '\', \'right\')"><i class="icon-arrow-right"></i></a></span><span style="display: block; text-align:center;">' . JText::_('TPL_GENSHOP_FIELD_COLUMN_' . strtoupper($column[0])) . '</span> ' .
