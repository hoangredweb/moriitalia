...
class JFormFieldBrowserCompatibility extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html .= '<table class="table table-striped"><tr><th>' . JText::_('TPL_GENSHOP_BROWSER_COMPATIBILITY_BROWSER') . '</th><th>' . JText::_('TPL_GENSHOP_BROWSER_COMPATIBILITY_MINIMUM_VERSION') . '</th><th style="text-align:center;">' . JText::_('TPL_GENSHOP_BROWSER_COMPATIBILITY_DESKTOP') . '</th><th style="text-align:center;">' . JText::_('TPL_GENSHOP_BROWSER_COMPATIBILITY_RECOMMENDED') . '</th><th style="text-align:center;">' . JText::_('TPL_GENSHOP_BROWSER_COMPATIBILITY_MOBILE') . '</th></tr>';
