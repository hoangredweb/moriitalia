...
class lessc_formatter_classic_rw {
	public $indentChar = "  ";
...
class lessc_formatter_compressed_rw extends lessc_formatter_classic_rw {
...
class lessc_formatter_lessjs_rw extends lessc_formatter_classic_rw {
	public $disableSingle = true;
