...
for ($i = 0; $i < count($rows); $i++)
{
	...
	if (!$row->not_for_sale && $showPrice)
	{
		...
		if (SHOW_PRICE && (!DEFAULT_QUOTATION_MODE || (DEFAULT_QUOTATION_MODE && SHOW_QUOTATION_PRICE)))
		{
			...
			$displyText = "<div class=\"mod_product_price_wrapper\"><div class=\"inner row\"><div class=\"mod_redshop_products_title\"><a href=\"" . $link . "\" title=\"\">" . JHTML::_('string.truncate', $row->product_name, 60) . "</a></div><div class=\"mod_redshop_products_price col-xs-12 align-left\">" . $productDiscountPrice . "</div></div></div>";
				...
				if ($productOldPrice > $productPriceDiscount)
				{
					...
					if ($showDiscountPriceLayout)
					{
						...
						echo "<div class=\"on_sale_wrap\">";
	                        ...
	                        echo "</div>";
	                    echo "</div>";
	                    echo "<div class=\"mod_redshop_products_title\"><a href=\"" . $link . "\" title=\"\">" . JHTML::_('string.truncate', $row->product_name, 60) . "</a></div>";
                ...
                echo "{tab ". JText::_('REDSHOP_PRODUCT_MODAL_INFO_TEXT')."}";
                    echo "<div class=\"product row\">";
                      echo "<div class=\"col-sm-4 col-xs-12 product-left\">";
                        ...
                        echo "</div>";
                    	echo "<div class=\"div_compare div_compare_modal\">";
                          ...
                          echo "<div class=\"redSHOP_product_box_right\">";
                            echo "<div class=\"redSHOP_product_detail_box\">";
                              echo "<div class=\"brand\">";
                                echo JText::_('COM_REDSHOP_MANUFACTURER_LBL')." <a href=\"index.php?option=com_redshop&view=manufacturers&layout=product&Itemid=" . $Itemid . "\">" . $row->manufacturer_name . "</a>";
                              echo "</div>";
