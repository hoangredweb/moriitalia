...
<div class="visitorcounter <?php echo $moduleclass_sfx ?>">
    <?php if(!$horizontal) : ?>
        <?php if($s_today) : ?>
            <p>
                <?php echo JText::_('MOD_VISITORCOUNTER_TODAY'); ?>
                <span class="floatright"><?php echo $today_visitors ?></span>
            </p>
        <?php endif; ?>
        <?php if($s_yesterday) : ?>
            <p>
                <?php echo JText::_('MOD_VISITORCOUNTER_YESTERDAY'); ?>
                <span class="floatright"><?php echo $yesterday_visitors ?></span>
            </p>
        <?php endif; ?>
        <?php if($s_week) : ?>
            <p>
                <?php echo JText::_('MOD_VISITORCOUNTER_WEEK'); ?>
                <span class="floatright"><?php echo $week_visitors ?></span>
            </p>
        <?php endif; ?>
        <?php if($s_month) : ?>
            <p>
                <?php echo JText::_('MOD_VISITORCOUNTER_MONTH'); ?>
                <span class="floatright"><?php echo $month_visitors ?></span>
            </p>
        <?php endif; ?>
        <?php if($s_all) : ?>
            <p>
                <?php echo JText::_('MOD_VISITORCOUNTER_ALL'); ?>
