...
<h1><?php echo $this->escape(JText::_('COM_REDSHOP_ORDER_RECEIPT')); ?></h1>

<table width="100%" class="checkout-bar" border="0" cellspacing="2" cellpadding="2">
	<tr>
		<td width="33%" class="checkout-bar-1 done" valign="top"><span class="bg"><?php echo JText::_('COM_REDSHOP_LOGIN_SIGNUP');?></span></td>
		<td width="33%" class="checkout-bar-2 done" valign="top"><span class="bg"><?php echo JText::_('COM_REDSHOP_PAYMENT');?></span></td>
		<td width="33%" class="checkout-bar-3-active" valign="top"><span class="bg"><?php echo JText::_('COM_REDSHOP_RECEIPT'); ?></span></td>
	</tr>
</table>
<?php
...
$ReceiptTemplate = str_replace("{order_lbl}", JText::_('COM_REDSHOP_ORDER'), $ReceiptTemplate);
$ReceiptTemplate = str_replace("{payment_method_lbl}", JText::_('COM_REDSHOP_PAYMENT_METHOD'), $ReceiptTemplate);
$ReceiptTemplate = str_replace("{shipping_method_lbl}", JText::_('COM_REDSHOP_SHIPPING_METHOD'), $ReceiptTemplate);
...
$print_tag = "<a class='btnprint' " . $onclick . " title='" . JText::_('COM_REDSHOP_PRINT_LBL') . "'>";
