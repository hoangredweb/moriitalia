...
$ati_img = '<img class="aticle-image" src="'. $images->image_intro .'" alt="aticle image" />';
?>
<div class="item-page<?php echo $this->pageclass_sfx; ?> articleitem" itemscope itemtype="http://schema.org/Article">
	...
	<?php if (isset ($this->item->toc)) :
		echo $this->item->toc;
			...
			<div class="blog_post_title hide"><?php echo $this->escape($this->item->title); ?></div>

			<div itemprop="articleBody" class="blog-post">

				<?php if (isset($images->image_intro) && $images->image_intro != ''): ?>
					<div class="blog_articleImage">
						<?php echo $ati_img;?>
					</div>
				<?php endif ?>
