...
function displayAdditionalImage(product_id, accessory_id, relatedprd_id, selectedproperty_id, selectedsubproperty_id) {
    ...
    request.onreadystatechange = function () {
        ...
        if (request.readyState == 4) {
            ...
            if (document.getElementById('product_more_videos') && arrResponse[16] != "") {
    ...
    request.onreadystatechange = function () {
        if (request.readyState == 4) {
            ...
            if (document.getElementById('mod_cart_total') && responce[1]) {
                ...
                var totalQuantity = jQuery('#cart-total-quantity').text();
                jQuery('.mod_cart_title .inner').html('0');
                jQuery('.mod_cart_title .inner').html(totalQuantity);
            }
