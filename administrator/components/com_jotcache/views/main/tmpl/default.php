...
<script language="javascript" type="text/javascript">
  Joomla.submitbutton = function (task) {
    ...
    if (task === 'recache.display'){
      jQuery('#system-message-container').append('<button data-dismiss="alert" class="close" type="button">×</button><div class="alert alert-info"><h4 class="alert-heading"><?php echo JText::_('JOTCACHE_RS_MSG_INFO'); ?></h4><p class="alert-message"><?php echo JText::_('JOTCACHE_RS_MSG_HINT'); ?></p></div>');
    }
...
?>
              <td align="center" style="padding-top:0;padding-left:0;">
                <table class="showcookies"><?php
                  foreach ($vars as $var) {
echo '<tr><td  style="border:0px;">' . $var . '</td></tr>';
}?></table>
              </td>
            <?php } ?>
