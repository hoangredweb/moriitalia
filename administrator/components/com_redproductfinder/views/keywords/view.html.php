 ...
 * @since    2.0
 */
class RedproductfinderViewKeywords extends JViewLegacy
{
	protected $items;
	...
	{
		/* add submenu here */
		RedproductfinderHelper::addSubmenu("keywords");
	...
	function toolbar()
	{
		...
		JToolbarHelper::deleteList('Are you sure you want to delete items', 'keywords.delete');
