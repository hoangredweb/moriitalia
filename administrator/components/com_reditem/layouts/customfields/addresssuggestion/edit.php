...
<div class="reditem_customfield_addresssuggestion">
	<input type="text" name="cform[addresssuggestion][<?php echo $field->fieldcode; ?>]" id="cform_addresssuggestion_<?php echo $field->fieldcode; ?>" value="<?php echo $field->value; ?>" <?php echo $attributes; ?> />
...
(function($){
	$(document).ready(function($){
		...
		var reditem_address_suggestion_<?php echo $field->fieldcode; ?> = document.getElementById('cform_addresssuggestion_<?php echo $field->fieldcode; ?>');
		...
		google.maps.event.addListener(reditem_address_suggestion_autocomplete_<?php echo $field->fieldcode; ?>, 'place_changed', function() {
			...
			$('#cform_addresssuggestion_<?php echo $field->fieldcode; ?>').val(correctAddress);
		});

		$("#cform_addresssuggestion_<?php echo $field->fieldcode; ?>").keyup(function(){
