...
$saveOrderUrl = 'index.php?option=com_reditem&task=fields.saveOrderAjax&tmpl=component';
...
{
	JHTML::_('rsortablelist.sortable', 'table-fields', 'adminForm', strtolower($listDirn), $saveOrderUrl, false, true);
}
...
<form action="index.php?option=com_reditem&view=fields" class="admin" id="adminForm" method="post" name="adminForm">
	...
	<?php else : ?>
	<table class="table table-striped table-hover" id="table-fields">
		<thead>
			<tr>
