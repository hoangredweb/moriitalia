...
$lists['user_point']   = JHTML::_('redshopselect.booleanlist', 'user_point', 'class="inputbox"', $this->config->get('USER_POINT'));
?>
<legend><?php echo JText::_('COM_REDSHOP_REGISTRATION'); ?></legend>
<div class="form-group">
	<span class="editlinktip hasTip"
			      title="<?php echo JText::_('COM_REDSHOP_USER_POINT_LBL'); ?>::<?php echo JText::_('COM_REDSHOP_USER_POINT_LBL'); ?>">
		<label for="name"><?php echo JText::_('COM_REDSHOP_USER_POINT_LBL');?></label>
	</span>
	<?php echo $lists ['user_point']; ?>
</div>
<div class="form-group">
	<span class="editlinktip hasTip"
			      title="<?php echo JText::_('COM_REDSHOP_USER_AMOUNT_TO_POINT_LBL'); ?>::<?php echo JText::_('COM_REDSHOP_USER_AMOUNT_TO_POINT_LBL'); ?>">
		<label><?php echo JText::_('COM_REDSHOP_USER_AMOUNT_TO_POINT_LBL');?></label></span>
	<input type="text" name="user_amount_to_point" id="user_amount_to_point" value="<?php echo $this->config->get('USER_AMOUNT_TO_POINT'); ?>">
</div>
<div class="form-group">
	<span class="editlinktip hasTip"
			      title="<?php echo JText::_('COM_REDSHOP_USER_POINT_TO_AMOUNT_LBL'); ?>::<?php echo JText::_('COM_REDSHOP_USER_POINT_TO_AMOUNT_LBL'); ?>">
		<label><?php echo JText::_('COM_REDSHOP_USER_POINT_TO_AMOUNT_LBL');?></label></span>
	<input type="text" name="user_point_to_amount" id="user_amount_to_point" value="<?php echo $this->config->get('USER_POINT_TO_AMOUNT'); ?>">
</div>
<div class="form-group">
	<span class="editlinktip hasTip"
